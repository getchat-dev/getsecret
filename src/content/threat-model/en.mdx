---
title: "Threat model"
lede: "A map of what Burnotes protects, who it protects you from, and — just as important — where it stops. If a risk isn't on this page, assume we don't cover it."
metaDescription: "What Burnotes protects, who it protects you from, and where it stops: the risks it covers, the ones it doesn't, and how to report a vulnerability."
---

This page is written for people deciding whether they can rely on Burnotes for a specific job. If you just want a plain walkthrough of how it works, read [Security](/security) instead.
...
These are the things Burnotes prevents:
...
This is the part that matters most. Burnotes does **not** protect against any of the following, and no setting changes that:
...
- **Quantum adversaries.** AES-GCM is not post-quantum. If your threat model includes an attacker with a future quantum computer harvesting today's traffic, Burnotes is not the right tool.
...
If any of these describe your situation, Burnotes is the wrong tool.

## Reporting a vulnerability

If you find a security issue, please report it privately — don't open a public issue or post it in a chat.

Report it through a [GitHub security advisory](https://github.com/Markuper-tech/burnotes/security/advisories/new), which keeps the discussion private until a fix is out. Tell us what you found, how to reproduce it, and the impact you see. We'll confirm we received it and keep you posted while we work on it.
